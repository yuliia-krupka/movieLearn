            ...
            <Layout className="account-root-layout">
                ...
                <Content className='content'>
                    ...
                    <div className="update-movie-container">
                        <Card className="update-movie-card" bordered={false}>
                            <Form
                                form={form}
                                layout="vertical"
                                    ...
                                    <>
                                        ...
                                        <Row>
                                            <Col span={24}>
                                                ...
                                                >
                                                    <TextArea rows={4} placeholder="Brief summary of the movie plot..." showCount maxLength={500} />
                                                </Form.Item>
                                            </Col>
                                        </Row>
                                                    ...
                                                    {currentScriptInfo && (
                                                        <div className="current-file-badge">
                                                            <div className="badge-header">
                                                                <Text strong style={{ color: '#52c41a' }}>Current Script Active</Text>
                                                                <Button
                                                                    size="small"
                                                                    danger
                                                                    type="text"
                                            ...
                                            <Col span={24}>
                                                <div className="file-section">
                                                    ...
                                                    {currentImageUrl && !imageUpload.file && (
                                                        <div className="current-file-badge">
                                                            <div className="badge-header">
                                                                <Text strong style={{ color: '#52c41a' }}>Current Poster Active</Text>
                                                                <Button
                                                                    size="small"
                                                                    danger
                                                                    type="text"
